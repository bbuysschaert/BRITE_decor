...
import BRITE.timing.hjdcorrection as hjdcorrectionBRITE
import BRITE.timing.orbit as orbitBRITE

import BRITE.clipping.medianclipping as medianclipBRITE
import BRITE.clipping.percentageclipping as percentageclipBRITE

import BRITE.gui.outlierrejection as outlierguiBRITE
#===============================================================================
# 				Settings
#===============================================================================
...
def perform_clipping(time, flux, xPOS, yPOS, temperature, qFLAG, exposureTIME, numberSTACKS, **kwargs):
    ...
    IDXoutliers = orbitBRITE.analyseNUMBERperORBIT(time, flux, numberSTACKS, satelliteORBITperiod)
